...
const ProfileDetail = () => {
  ...
  useEffect(() => {
    ...
    fetchProfile()
  }, [id, token, user?._id, user?.followings])
      ...
      <div className={classes.wrapper}>
        <div className={classes.top}>
          ...
          {profile?._id !== user._id && (
            <button onClick={handleFollowFunction} className={classes.followBtn}>
              {isFollowed ? 'Unfollow' : 'Follow'}
            </button>
          )}
        </div>
        <div className={classes.center}>
          <div className={classes.followings}>Followings: {profile?.followings?.length}</div>
          <div className={classes.followers}>Followers: {profile?.followers?.length}</div>
        </div>
